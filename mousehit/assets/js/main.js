...
function loadPreload() {
    ...
    // this.load.image('hammer','assets/images/icon.png')
    //加载音效
    ...
    this.load.spritesheet('hole', 'assets/images/bg_hole.png', {
        frameWidth: 144,
        frameHeight: 80
    })
    this.load.spritesheet('mouse', 'assets/images/mouse.png', {
        frameWidth: 137,
        frameHeight: 120
    })
    loadFn.call(this)
...
function createPlayer() {
    ...
    if (!that.anims.anims.has('hit' + rndPlayer)) {
        that.anims.create({
            key: 'hit' + rndPlayer,
            frames: that.anims.generateFrameNumbers('mouse', {
                start: playerRnd[rndPlayer].start,
                end: playerRnd[rndPlayer].end
            }),
            frameRate: 20,
        })
    }
